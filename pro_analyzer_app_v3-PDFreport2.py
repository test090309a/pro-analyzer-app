...
def generate_pdf_report(chat_history, file_name="pro_analyzer_report.pdf"):
    """
    Erstellt einen PDF-Report aus dem Chatverlauf (inkl. Bilder, Prompts, Antworten, Zeitstempel) und gibt den Dateipfad zurück.
    """
    ...
    # Optional: Bild aus letzter Interaktion (wenn vorhanden)
    # (Erweiterbar: mehrere Bilder, falls gewünscht)
    # story.append(Image(...))
